...
src/tune.py             → grid search TF-IDF max_features, plot F1 vs. max_features, saved to tuning_results/
...
![F1 vs max_features](tuning_results/f1_vs_max_features.png)
...
python -m src.tune            # grid search max_features, save F1 plot
